                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url('aplikasinya/tambah_catatan'); ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="time" name="jam" id="jam" class="form-control" value="<?= set_value('jam'); ?>" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Masukan Lokasi" value="<?= set_value('lokasi'); ?>" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="suhu" id="suhu" class="form-control" placeholder="Masukan Suhu Tubuh" value="<?= set_value('suhu'); ?>" required>
